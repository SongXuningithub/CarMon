...
public:
    ...
    CarMon(uint32_t memory_size, double layer1_ratio);
...
CarMon::CarMon(uint32_t memory_size, double layer1_ratio): 
layer1(memory_size * layer1_ratio), layer2(memory_size * (1 - layer1_ratio)){
    string ifile_name = "../../CarMon/support/error_removal.txt";
    ifstream ifile_hand;
