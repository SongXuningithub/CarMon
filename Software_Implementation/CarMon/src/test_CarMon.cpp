...
void write_perflow_spread(string dataset,string filename,CarMon& sketch,uint32_t tmpmem);
void write_real_distribution(string dataset,string filename,CarMon& sketch);
void write_sketch(string dataset,string filename,CarMon& sketch);
