...
void CarMon::report_superspreaders(vector<IdSpread>& superspreaders){
...
void CarMon::process_element(string flowid,string element) {
...
uint32_t CarMon::query_spread(string flowid){
    array<uint64_t,2> hash_flowid = str_hash128(flowid,HASH_SEED_1);
...
array<double,2> CarMon::GetLoadFactor(){
